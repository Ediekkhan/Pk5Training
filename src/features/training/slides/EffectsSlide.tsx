            ...
            return (
              <motion.button
                ...
                className={`group relative overflow-hidden rounded-2xl border p-4 text-left shadow-soft transition-all hover:-translate-y-0.5 hover:shadow-elevated ${
                  done ? "border-gold/60 bg-primary-soft ring-1 ring-gold/40" : "border-border bg-white hover:border-gold/50"
                }`}
              >
                {done && (
                ...
                <div className={`mb-3 grid size-10 place-items-center rounded-xl ${
                  done ? "gold-gradient text-white shadow-gold" : "bg-primary-soft text-gold-dark group-hover:gold-gradient group-hover:text-white transition-all"
                }`}>
